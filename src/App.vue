    ...
    <div id="mainpart" class="container mt-5 jn-container">
        ...
        >
            ...
            <button
                ...
                style="bottom: 66px; right: 20px; z-index: 1050"
                @click="toggleInfoMask"
            >
                <i :class="infoMaskLevel === 0 ? 'bi bi-eye' : 'bi bi-eye-slash'" />
            </button>
        </div>
    </div>
    <Footer />
        ...
        registerShortcutKeys() {
            const shortcutConfig = [
                ...
                },
                {
                    keys: 'j',
                    action: () => {
                        ;(navigateCards('down'), this.$trackEvent('ShortCut', 'ShortCut', 'GoNext'))
                    },
                ...
                },
                {
                    keys: 'k',
                    action: () => {
                        ;(navigateCards('up'), this.$trackEvent('ShortCut', 'ShortCut', 'GoPrevious'))
                    },
                ...
                },
                {
                    keys: 'R',
                    action: () => {
                        ;(this.refreshEverything, this.$trackEvent('ShortCut', 'ShortCut', 'RefreshEverything'))
                    },
