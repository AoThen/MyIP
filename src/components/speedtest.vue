<template>
    ...
    <div class="speed-test-section mb-4">
        <div class="jn-title2">
            ...
            >
                <i :class="speedTestStatus === 'running' ? 'bi bi-slash-circle' : 'bi bi-caret-right-fill'" />
            </button>
        </div>
            ...
            <div class="col-12 mb-3">
                <div class="card jn-card" :class="{ 'dark-mode dark-mode-border': isDarkMode }">
                    <div class="card-body">
                        <div
                            class="progress"
                            style="height: 20px; margin: 4pt 0 20pt 0"
                            :class="{ 'jn-opacity-0': speedTestStatus == 'idle', 'jn-progress-dark': isDarkMode }"
                        >
                            <div
                                class="progress-bar progress-bar-striped progress-bar-animated bg-success jn-progress"
                                role="progressbar"
                                style="width: 0%"
                                aria-valuenow="0"
                        ...
                        <div class="row" style="margin-bottom: 10pt">
                            <div :class="['text-center', isMobile ? 'col-6' : 'col-3']">
                                <h5 class="speedtest-h5">
                                    {{ $t('speedtest.Download') }}
                                </h5>
                                <p
                                    id="download-speed"
                                    class="speedtest-h5"
                                    :class="updateSpeedTestColor(speedTestStatus)"
                                >
                        ...
                        <div v-if="speedTestStatus === 'finished'" class="row jn-speedtest-note">
    ...
    methods: {
        ...
        startSpeedTest() {
            ...
            newEngine.onResultsChange = ({ type }) => {
                ...
                if (
                    rawData.latency &&
                    rawData.latency.results &&
                    rawData.latency.results.timings &&
                    rawData.latency.results.timings.length > 0
                ) {
