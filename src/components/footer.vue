    ...
    <footer>
        ...
        <div id="about" class="text-center mb-2">
            <a
                ...
                :class="[isDarkMode ? 'link-info' : 'link-dark']"
        ...
        <div
            id="About"
            class="offcanvas offcanvas-end mt-5"
        ...
        >
            <div class="offcanvas-header mt-3">
                <div class="btn-group" role="group">
                    <button
                        type="button"
                        class="btn"
                        :class="[showAbout ? 'btn-primary' : 'btn-outline-secondary']"
            ...
            <div ref="offcanvasBody" class="offcanvas-body">
                <div v-if="showAbout">
                    <div class="mb-3">
                        <p>
                            {{ $t('about.product1') }}
                    ...
                    <div class="mb-3" v-html="$t('about.contact')" />
                </div>
                <div v-if="showChanglog">
                    <div v-for="(version, index) in changelog.slice().reverse()" :key="index" class="mb-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 row flex-row-reverse text-secondary">
                                {{ version.date }}
                            </div>
                        </div>
                        <hr />
                        ...
                        <div v-for="(item, idx) in version.content" :key="idx" class="pb-1">
                            <span v-if="item.type === 'add'" class="badge rounded-pill bg-success fw-normal">
                                {{ $t('changelog.add') }}
                            </span>
        ...
        <div v-if="!siteValidate" id="copyright">
            <p class="text-center fs-6 fw-light" style="opacity: 0.5">
                {{ $t('page.copyRightName') }}
                <a
                    :href="$t('page.copyRightLink')"
                    class="link-underline-light"
                    target="_blank"
                    :class="[isDarkMode ? 'dark-mode link-light' : 'link-dark']"
                >
