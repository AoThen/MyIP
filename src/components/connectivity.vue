        ...
        <div class="availability-test-section mb-4">
            <div class="jn-title2">
                ...
                <button
                    ...
                    @click="checkAllConnectivity(false, true)"
                >
                        ...
                        <div class="card-body">
                            ...
                            <p
                                ...
                                :class="{
                                    ...
                                    'text-success': test.status.includes($t('connectivity.StatusAvailable')),
                                    'text-danger':
                                        test.status === $t('connectivity.StatusUnavailable') ||
                                        test.status === $t('connectivity.StatusTimeout')
                                }"
                                v-html="test.status"
                            ></p>
                        </div>
    ...
    methods: {
        ...
        checkConnectivityHandler(test, isAlertToShow, onTestComplete) {
            ...
            img.onload = () => {
                ...
                test.status = this.$t('connectivity.StatusAvailable') + ` ( ${+new Date() - beginTime} ms )`
                onTestComplete(true)
            }
