            ...
            <div class="col-12 mb-3">
                <div class="card jn-card" :class="{ 'dark-mode dark-mode-border': isDarkMode }">
                    <div class="card-body">
                            ...
                            <div class="col-12 col-md-auto mt-2 mt-md-0">
                                <div class="row justify-content-between">
                                    <div class="col-auto">
                                        <select
                                            id="mtrIP"
                                            class="form-select jn-ping-form-select"
                                            v-model="selectedIP"
                                    ...
                                    <div class="col-auto">
                                        ...
                                        >
                                            <span
                                                v-if="
                                                    mtrCheckStatus === 'idle' ||
                                                    mtrCheckStatus === 'finished' ||
                                                    mtrCheckStatus === 'error'
                                                "
                                            >
                                                {{ $t('mtrtest.Run') }}
                                            </span>
                                            <span
                                                v-if="mtrCheckStatus === 'running'"
                        ...
                        <!-- Result Display -->
                        <div v-if="mtrResults.length > 0" id="mtrresult">
                            <div id="mtrResultsAccordion" class="accordion" :data-bs-theme="isDarkMode ? 'dark' : ''">
                                <div v-for="(result, index) in mtrResults" class="accordion-item" :key="result.country">
                                    <h2 :id="'heading' + index" class="accordion-header">
                                        ...
                                        >
                                            <span :class="'fi fi-' + result.country.toLowerCase()" />
                                            &nbsp;
                                            ...
                                            <span
                                                ...
                                                :class="isDarkMode ? 'text-bg-warning' : 'text-bg-success'"
                                            >
                                                AS{{ result.asn }}
                                            </span>
                                        </button>
                                    ...
                                    >
                                        <div class="accordion-body">
                                            <div
                                                class="card card-body border-0 mt-3"
                        ...
                        <div v-if="mtrCheckStatus === 'error'" id="mtrresult-error">
