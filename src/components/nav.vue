<template>
    ...
    <nav
        id="navbar-top"
        class="navbar navbar-expand-lg bg-body-tertiary px-3 mb-3 jn-navbar-top"
        :class="{ 'dark-mode-nav navbar-dark bg-dark': isDarkMode }"
    >
        <div class="jn-logo">
            <a
                class="navbar-brand d-flex align-items-center align-content-center"
                :class="{ 'text-white': isDarkMode }"
                href="#"
                @click="handleLogoClick"
            >
                <svg
                    :style="{ fill: isDarkMode ? '#fff' : '#212529' }"
                    class="me-1"
                    width="23"
                    height="23"
            ...
            <div class="btn-group mx-1" :data-bs-theme="isDarkMode ? 'dark' : 'light'">
                <button
                    type="button"
                    class="btn btn-sm dropdown-toggle jn-button"
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a
                            class="dropdown-item"
                            href="?hl=zh"
                            @click="$trackEvent('Nav', 'ToggleClick', 'LanguageChange')"
                        >
                            <i class="fi fi-cn" />
                            中文
                        </a>
            ...
            <div>
                ...
                <label class="switch" for="toggleBtn">
                    <i class="bi bi-moon-stars text-light" />
        ...
        <div id="navbarNavAltMarkup" class="collapse navbar-collapse justify-content-end">
            <div class="navbar-nav">
                <a
                    class="nav-link"
                    :class="{ 'text-white jn-deactive': isDarkMode }"
                    href="#IPInfo"
                    @click="$trackEvent('Nav', 'NavClick', 'IPInfo')"
                >
                    {{ $t('nav.IPinfo') }}
                </a>
                <a
                ...
                <a
                    ...
                    :class="{ 'text-white jn-deactive': isDarkMode }"
                    href="#WebRTC"
                    @click="$trackEvent('Nav', 'NavClick', 'WebRTC')"
                >
                    {{ $t('nav.WebRTC') }}
                </a>
                <a
                ...
                <a
                    ...
                    :class="{ 'text-white jn-deactive': isDarkMode }"
                    href="#SpeedTest"
                    @click="$trackEvent('Nav', 'NavClick', 'SpeedTest')"
                >
                    {{ $t('nav.SpeedTest') }}
                </a>
                <a
                    ...
                    :class="{ 'text-white jn-deactive': isDarkMode }"
                    href="#PingTest"
                    @click="$trackEvent('Nav', 'NavClick', 'PingTest')"
                >
                    {{ $t('nav.PingTest') }}
                </a>
                <a
                    ...
                    :class="{ 'text-white jn-deactive': isDarkMode }"
                    href="#MTRTest"
                    @click="$trackEvent('Nav', 'NavClick', 'MTRTest')"
                >
                    {{ $t('nav.MTRTest') }}
                </a>
            </div>
