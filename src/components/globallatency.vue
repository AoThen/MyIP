            ...
            <div class="col-12 mb-3">
                <div class="card jn-card" :class="{ 'dark-mode dark-mode-border': isDarkMode }">
                    <div class="card-body">
                                        ...
                                        >
                                            <span
                                                v-if="
                                                    ...
                                                    pingCheckStatus === 'finished' ||
                                                    pingCheckStatus === 'error'
                                                "
                                            >
                                                {{ $t('pingtest.Run') }}
                                            </span>
                                            <span
                                                v-if="pingCheckStatus === 'running'"
                        ...
                        <!-- Result Display -->
                        <div v-if="pingResults.length > 0" id="pingresult">
                                ...
                                <table class="table" :class="{ 'table-dark': isDarkMode }">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">
                                                {{ $t('pingtest.TotalPackets') }}
                                            </th>
                                            <th scope="col">
                                                {{ $t('pingtest.PacketLoss') }}
                                            </th>
                                            <th scope="col">
                                                {{ $t('pingtest.ReceivedPackets') }}
                                            </th>
                                            <th scope="col">
                                                {{ $t('pingtest.DroppedPackets') }}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="result in pingResults" :key="result.country">
                                            ...
                                            <td :class="result.stats.min < 100 ? 'text-success' : ''">
                                                {{ result.stats.min.toFixed(1) }}
                                            </td>
                                            <td :class="result.stats.max < 100 ? 'text-success' : ''">
                                                {{ result.stats.max.toFixed(1) }}
                                            </td>
                                            <td :class="result.stats.avg < 100 ? 'text-success' : ''">
                        ...
                        <div v-if="pingCheckStatus === 'error'" id="pingresult-error">
